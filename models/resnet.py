...
def resnet18(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNetMNIST:
...
def resnet34(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNetMNIST:
